...
const Nav = () => {
  ...
  const [adminMenu, setAdminMenus] = React.useState([
    "Users",
    "Documents",
    "Media",
    "Leads",
  ...
  const [agentMenu, setAgentMenus] = React.useState([
    "Students",
    "Counsellings"
  ])

  const [accountMenu, setAccountMenus] = React.useState([
    "Payments",
  ])
  ...
  React.useEffect(() => { 
    ...
    if (user.roles == 'accountant') { setMenus(accountMenu) }
              ...
              <div style={{}}>
                <div className="nav-group__content">
                  ...
                  {menu.includes("Users") && (
                    ...
                    >
                      <span className="nav__link-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="22px" height="22px" fill="#ffffff"><path fill="#ffffff" d="M12,12A6,6,0,1,0,6,6,6.006,6.006,0,0,0,12,12ZM12,2A4,4,0,1,1,8,6,4,4,0,0,1,12,2Z" /><path d="M12,14a9.01,9.01,0,0,0-9,9,1,1,0,0,0,2,0,7,7,0,0,1,14,0,1,1,0,0,0,2,0A9.01,9.01,0,0,0,12,14Z" /></svg>
                      </span>
                      <span className="nav__link-label">Users</span>
                    </a>
                  )}
                  
                  {menu.includes("Documents") && (
                    <a
                      className="nav__link"
                      id="nav-documents"
                  ...
                  {menu.includes("Holidays") && (
                    ...
                    >
                      <span className="nav__link-icon">
                        <svg fill="#ffffff" xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="22px" height="22px"><path fill="#ffffff" d="M19,2H18V1a1,1,0,0,0-2,0V2H8V1A1,1,0,0,0,6,1V2H5A5.006,5.006,0,0,0,0,7V19a5.006,5.006,0,0,0,5,5H19a5.006,5.006,0,0,0,5-5V7A5.006,5.006,0,0,0,19,2ZM2,7A3,3,0,0,1,5,4H19a3,3,0,0,1,3,3V8H2ZM19,22H5a3,3,0,0,1-3-3V10H22v9A3,3,0,0,1,19,22Z" /><circle cx="12" cy="15" r="1.5" /><circle cx="7" cy="15" r="1.5" /><circle cx="17" cy="15" r="1.5" /></svg>
                      </span>
                      <span className="nav__link-label">Holidays</span>
                    </a>
                  )}

                  {menu.includes("Employees") && (
                    <a
                      className="nav__link"
                      id="nav-employees"
                    ...
                    >
                      <span className="nav__link-icon">
                        <svg fill="#ffffff" xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="22px" height="22px"><path fill="#ffffff" d="M12,12A6,6,0,1,0,6,6,6.006,6.006,0,0,0,12,12ZM12,2A4,4,0,1,1,8,6,4,4,0,0,1,12,2Z" /><path d="M12,14a9.01,9.01,0,0,0-9,9,1,1,0,0,0,2,0,7,7,0,0,1,14,0,1,1,0,0,0,2,0A9.01,9.01,0,0,0,12,14Z" /></svg>
                      </span>
